...
### Identification of outliers - automatic PCA-based method
...
### Running a differential expression with Likelihood Ratio Test (LRT)
...
### Loading a DESEq2 object into environment
...
## Clustering approaches and problems
...
#### Problems with the clustering method
...
## SC3 library - clustering example
...
Please refer to the **Starting the analysis** and **Expression QC** sections of this tutorial.
...
### Clustering solution
In this step SC3 will provide you with a clustering solution. When calculating consensus for each value of `k`, `SC3` averages the clustering results of kmeans using a consensus approach.
